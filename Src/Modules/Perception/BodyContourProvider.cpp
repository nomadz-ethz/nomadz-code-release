...
void BodyContourProvider::add(const Pose3D& origin, const std::vector<Vector3<>>& c, float sign, BodyContour& bodyContour) {
  Vector2<int> q1, q2;
  ...
  for (unsigned i = 1; i < c.size(); ++i) {
    ...
    if (valid1 && valid2 && (q1.y < theCameraInfo.height || q2.y < theCameraInfo.height) && (q1.x >= 0 || q2.x >= 0) &&
