...
void CoordinateSystemProvider::update(ImageCoordinateSystem& imageCoordinateSystem) {
  ...
  imageCoordinateSystem.rotation[0] = horizon.direction;
  imageCoordinateSystem.rotation[1] = Vector2<>(-horizon.direction.y, horizon.direction.x);
  ...
  calcScaleFactors(imageCoordinateSystem.a,
                   imageCoordinateSystem.b,
                   theFilteredJointData.timeStamp - cameraMatrixPrevTimeStamp[theCameraInfo.camera]);
