...
#include "Cabsl.h"
  ...
  private:
    ...
    BehaviorConfig theRobotBehaviorConfig;
...
#include "Options.h"
  ...
  public:
    ...
    Behavior(const BehaviorControlBase& base, BehaviorControlOutput& behaviorControlOutput)
      ...
      stream >> theRobotBehaviorConfig;
      behaviorConfigChanged();
    ...
    void update(const std::vector<OptionInfos::Option>& roots) {
      ...
      MODIFY("parameters:robotBehavior", theRobotBehaviorConfig);
      behaviorConfigChanged();
    ...
    /* call this after theRobotBehaviorConfig changed */
    void behaviorConfigChanged() {
      // update data, that will be sent to team mates
      theBehaviorStatus.role = theRobotBehaviorConfig.role;
    }
...
class BehaviorControl : public BehaviorControlBase {
  ...
  (Vector2<>)kickOffsetPass, (Vector2<>)setPosKeeper, (Vector2<>)setPosStriker, (Vector2<>)setPosSupporter,
  (Vector2<>)setPosDefenderEven, (Vector2<>)setPosDefenderOdd, (Vector2<>)setPosOther, (Vector2<>)setPosKickoffKeeper,
  (Vector2<>)setPosKickoffStriker, (Vector2<>)setPosKickoffSupporter, (Vector2<>)setPosKickoffDefenderEven,
  (Vector2<>)setPosKickoffDefenderOdd, (Vector2<>)setPosKickoffOther, (Vector2<>)setPosStrikerTargetOne,
  (Vector2<>)setPosStrikerTargetTwo, (bool)optimizeStrategy,
});
...
void update(BehaviorControlOutput& behaviorControlOutput) {
  ...
  if (theFrameInfo.time) {
    behaviorControlOutput.behaviorStatus.teamColor =
      theOwnTeamInfo.teamColor == TEAM_BLUE ? BehaviorStatus::blue : BehaviorStatus::red;
...
void update(PersonalData& personalData) {
  personalData = theBehaviorControlOutput.personalData;
}
