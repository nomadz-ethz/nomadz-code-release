...
void MotionCombinator::update(JointRequest& jointRequest) {
  ...
  if (theMotionSelection.ratios[theMotionSelection.targetMotion] == 1.f) {
    ...
    case MotionRequest::walk: {
      ...
      motionInfo.motionRequest.walkRequest.stepRequest = theSpeedInfo.currentCustomStep;
...
#endif
  PLOT("module:MotionCombinator:leftLegAngles[0]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 0]);
  PLOT("module:MotionCombinator:leftLegAngles[1]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 1]);
  PLOT("module:MotionCombinator:leftLegAngles[2]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 2]);
  PLOT("module:MotionCombinator:leftLegAngles[3]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 3]);
  PLOT("module:MotionCombinator:leftLegAngles[4]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 4]);
  PLOT("module:MotionCombinator:leftLegAngles[5]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 5]);

  PLOT("module:MotionCombinator:rightLegAngles[0]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 6]);
  PLOT("module:MotionCombinator:rightLegAngles[1]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 7]);
  PLOT("module:MotionCombinator:rightLegAngles[2]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 8]);
  PLOT("module:MotionCombinator:rightLegAngles[3]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 9]);
  PLOT("module:MotionCombinator:rightLegAngles[4]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 10]);
  PLOT("module:MotionCombinator:rightLegAngles[5]", jointRequest.jointAngles.angles[JointData::LHipYawPitch + 11]);
...
void MotionCombinator::balanceUpperBody(JointRequest& jointRequest) {
  ...
  if (!isWalk || theSpeedInfo.speed.translation.abs() > 0.001f || std::abs(theSpeedInfo.speed.rotation) > 0.001f) {
