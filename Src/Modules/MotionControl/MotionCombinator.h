...
LOADS_PARAMETER(bool, useDynamicStiffness)
LOADS_PARAMETER(float, maxJointErrorLimit)
LOADS_PARAMETER(float, dynamicStiffnessScaler)
LOADS_PARAMETER(Rangei, dynamicStiffnessRange)
LOADS_PARAMETER(bool, saveJoint2File)
END_MODULE
...
private:
  ...
  bool wasInBalance;
  unsigned lastSaveTime;
  OdometryData lastOdometryData;
  JointRequest lastJointRequest;
  bool lastSaveJoint2FileValue;
