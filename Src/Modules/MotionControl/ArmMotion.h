...
public:
  ...
  STREAMABLE(ArmAngles,
             {
               ,
               (std::vector<float>)(6, 0.f)angles, /**< Array of size 6, containing target angles for shoulder+elbow joint */
               (std::vector<int>)(6, 0)
                 hardness,    /**< Array of size 6, containing hardness data to set while targetting the above angles */
  ...
  ArmAngles& getTargetState() { return *states.rbegin(); }
  ,
