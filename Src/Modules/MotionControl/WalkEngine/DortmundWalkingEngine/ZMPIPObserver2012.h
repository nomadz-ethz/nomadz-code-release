...
public:
  ZMPIPObserver2012(const ControllerParams& theControllerParams,
      ...
      : theControllerParams(theControllerParams), theTargetCoM(theTargetCoM), theWalkingEngineParams(theWalkingEngineParams),
        thePatternGenRequest(thePatternGenRequest), theZMPModel(theZMPModel), theWalkingInfo(theWalkingInfo),
        theActualCoM(theActualCoM), isStable(true),
...
private:
  ...
  RingBufferNew<Vector2f, MAX_SENSOR_DELAY> delayBuffer, /**< Buffer to deal with the sensor delay. */
