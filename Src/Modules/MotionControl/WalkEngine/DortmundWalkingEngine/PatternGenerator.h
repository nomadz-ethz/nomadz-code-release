...
#include "Tools/DortmundWalkingEngine/Parameters.h"
...
public:
   ...
   */
  PatternGenerator(const WalkingEngineParams& theWalkingEngineParams,
...
protected:
  ...
  bool isSpeed0() {
    return (thePatternGenRequest.speed.translation.x == 0) & (thePatternGenRequest.speed.translation.y == 0) &
           (thePatternGenRequest.speed.rotation == 0);
  };

  /* SpeedInfo related stuff */
  RingBufferWithSumNew<Pose2D, ControllerParams::N> speedBuffer;
  bool decelByAcc;
