...
public:
   ...
   * @param theInertiaSensorData Data from sensors.
   ...
   */
  ZMPIPControllerNG(const RobotModel& theRobotModel,
...
private:
  ...
  RingBufferWithSumNew<Point, MAX_SENSOR_DELAY> delayBuffer, /**< Buffer to deal with the sensor delay. */
    positionDelayBuffer, coMDelayBuffer;                     /**< Buffer to deal with the sensor delay. */
