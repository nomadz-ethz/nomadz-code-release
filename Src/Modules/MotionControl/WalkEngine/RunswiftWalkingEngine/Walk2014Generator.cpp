...
void Walk2014Generator::calcJoints(WalkGeneratorData& generator,
  ...
  */
  ...
  if (theArmMotionRequest.motion[0] == ArmMotionRequest::ArmMotionId::useDefault) {
    ...
    generator.jointRequest.jointAngles.angles[JointData::LShoulderPitch] = 115_deg;
    generator.jointRequest.jointAngles.angles[JointData::LShoulderRoll] = -8_deg;
    generator.jointRequest.jointAngles.angles[JointData::LWristYaw] = -90_deg;
  }
  if (theArmMotionRequest.motion[1] == ArmMotionRequest::ArmMotionId::useDefault) {
    ...
    generator.jointRequest.jointAngles.angles[JointData::RShoulderPitch] = 115_deg;
    generator.jointRequest.jointAngles.angles[JointData::RShoulderRoll] = 8_deg;
    generator.jointRequest.jointAngles.angles[JointData::RWristYaw] = 90_deg;
  }
