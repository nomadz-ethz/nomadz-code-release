...
public:
  ...
  enum BrushStyle { noBrush, solidBrush };
...
public:
  ...
  ColorRGBA(const unsigned char c[4]) : r(c[0]), g(c[1]), b(c[2]), a(c[3]) {}

  ColorRGBA(const ColorRGBA& other) { *this = other; }
  ...
  ColorRGBA(ColorClasses::Color colorClass) {
    ...
    case ColorClasses::yellow:
      ...
      b = 0;
      break;
    case ColorClasses::blue1:
      r = 0;
      g = 0;
      b = 139;
      break;
    case ColorClasses::blue2:
      r = 0;
      g = 0;
      b = 255;
      break;
    case ColorClasses::blue3:
      r = 135;
      g = 206;
      b = 235;
      break;
    case ColorClasses::green1:
      r = 0;
      g = 100;
      b = 0;
      break;
    case ColorClasses::green2:
      r = 0;
      g = 168;
      b = 0;
      break;
    case ColorClasses::green3:
      r = 0;
      g = 255;
      b = 0;
      break;
    ...
    case ColorClasses::black:
      ...
      b = 0;
      break;
    case ColorClasses::red1:
      r = 139;
      g = 0;
      b = 0;
      break;
    case ColorClasses::red2:
      r = 255;
      g = 0;
      b = 0;
      break;
    case ColorClasses::red3:
      r = 220;
      g = 20;
      b = 60;
      break;
    case ColorClasses::purple1:
      r = 128;
      g = 0;
      b = 128;
      break;
    case ColorClasses::purple2:
      r = 255;
      g = 0;
      b = 255;
      break;
    case ColorClasses::purple3:
      r = 238;
      g = 130;
      b = 238;
      break;
    case ColorClasses::customized:
      r = 255;
      g = 128;
      b = 128;
      break;
...
#define CIRCLE(id, center_x, center_y, radius, penWidth, penStyle, penColor, fillStyle, fillColor)                          \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::circle << (char)Global::getDrawingManager().getDrawingId(id) << (int)(center_x)                  \
                                  << (int)(center_y) << (int)(radius) << (char)(penWidth) << (char)(penStyle)               \
                                  << ColorRGBA(penColor) << (char)(fillStyle) << ColorRGBA(fillColor));                     \
  })
...
#define ELLIPSE(id, center, radiusX, radiusY, rotation, penWidth, penStyle, penColor, fillStyle, fillColor)                 \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::ellipse << (char)Global::getDrawingManager().getDrawingId(id) << (int)(center.x)                 \
                                   << (int)(center.y) << (int)(radiusX) << (int)(radiusY) << (float)(rotation)              \
                                   << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor) << (char)(fillStyle)      \
                                   << ColorRGBA(fillColor));                                                                \
  })
...
#define RECTANGLE2(id, topLeft, width, height, rotation, penWidth, penStyle, penColor, fillStyle, fillColor)                \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::rectangle << (char)Global::getDrawingManager().getDrawingId(id) << (int)(topLeft.x)              \
                                     << (int)(topLeft.y) << (int)(width) << (int)(height) << (float)rotation                \
                                     << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor) << (char)(fillStyle)    \
                                     << ColorRGBA(fillColor));                                                              \
  })
...
#define POLYGON(id, numberOfPoints, points, penWidth, penStyle, penColor, fillStyle, fillColor)                             \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    ...
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::polygon << (char)Global::getDrawingManager().getDrawingId(id) << (int)numberOfPoints << _buf     \
                                   << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor) << (char)(fillStyle)      \
                                   << ColorRGBA(fillColor));                                                                \
    delete[] _buf;                                                                                                          \
  })
...
#define GRID_RGBA(id, x, y, cellSize, cellsX, cellsY, cells)                                                                \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    ...
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::gridRGBA << (char)Global::getDrawingManager().getDrawingId(id) << int(x) << int(y)               \
                                    << int(cellSize) << int(cellsX) << int(cellsY) << _buf);                                \
    delete[] _buf;                                                                                                          \
  })
...
#define GRID_MONO(id, x, y, cellSize, cellsX, cellsY, baseColor, cells)                                                     \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    ...
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::gridMono << (char)Global::getDrawingManager().getDrawingId(id) << int(x) << int(y)               \
                                    << int(cellSize) << int(cellsX) << int(cellsY) << ColorRGBA(baseColor) << _buf);        \
    delete[] _buf;                                                                                                          \
  })
...
#define DOT(id, x, y, penColor, fillColor)                                                                                  \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::dot << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y)                \
                               << ColorRGBA(penColor) << ColorRGBA(fillColor));                                             \
  })
...
#define DOT_AS_VECTOR(id, xy, penColor, fillColor)                                                                          \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::dot << (char)Global::getDrawingManager().getDrawingId(id) << (int)(xy.x) << (int)(xy.y)          \
                               << ColorRGBA(penColor) << ColorRGBA(fillColor));                                             \
  })
...
#define MID_DOT(id, x, y, penColor, fillColor)                                                                              \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::midDot << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y)             \
                                  << ColorRGBA(penColor) << ColorRGBA(fillColor));                                          \
  })
...
#define LARGE_DOT(id, x, y, penColor, fillColor)                                                                            \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::largeDot << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y)           \
                                    << ColorRGBA(penColor) << ColorRGBA(fillColor));                                        \
  })
...
#define LINE(id, x1, y1, x2, y2, penWidth, penStyle, penColor)                                                              \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::line << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x1) << (int)(y1)             \
                                << (int)(x2) << (int)(y2) << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor));  \
  })
...
#define ARROW(id, x1, y1, x2, y2, penWidth, penStyle, penColor)                                                             \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::arrow << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x1) << (int)(y1)            \
                                 << (int)(x2) << (int)(y2) << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor)); \
  })
...
#define POSE_2D_SAMPLE(id, p, color)                                                                                        \
  COMPLEX_DRAWING(id, {                                                                                                     \
    ...
    LINE(id,                                                                                                                \
         int(current.translation.x),                                                                                        \
         int(current.translation.y),                                                                                        \
         int(p.translation.x),                                                                                              \
         int(p.translation.y),                                                                                              \
         1,                                                                                                                 \
         Drawings::ps_solid,                                                                                                \
...
#define DRAWTEXT(id, x, y, fontSize, color, txt)                                                                            \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    ...
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::text << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y)               \
                                << (short)(fontSize) << (ColorRGBA)(color) << _buf);                                        \
    delete[] _buf;                                                                                                          \
  })
...
#define ORIGIN(id, x, y, angle)                                                                                             \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::origin << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y)             \
                                  << (float)(angle));                                                                       \
  })
 ...
 * @param id A drawing id
 */
#define COMPLEX_DRAWING(id, ...) NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, __VA_ARGS__;)
...
#define TIP(id, center_x, center_y, radius, text)                                                                           \
  NOT_POLLABLE_DEBUG_RESPONSE("debug drawing:" id, {                                                                        \
    ...
    OUTPUT(idDebugDrawing,                                                                                                  \
           bin,                                                                                                             \
           (char)Drawings::tip << (char)Global::getDrawingManager().getDrawingId(id) << (int)(center_x) << (int)(center_y)  \
                               << (int)(radius) << _buf);                                                                   \
    delete[] _buf;                                                                                                          \
  })
 ...
 */
#define PLOT(id, value) DEBUG_RESPONSE("plot:" id, OUTPUT(idPlot, bin, id << (float)(value));)

/**
 * A macro that declares a pollable plot.
 * @param id The name of the plot.
 */
#define DECLARE_PLOT(id) DEBUG_RESPONSE("plot:" id, )
...
#define DRAW_ROBOT_POSE(id, p, color)                                                                                       \
  COMPLEX_DRAWING(id, {                                                                                                     \
    ...
    dirVec += translation;                                                                                                  \
    LINE(id, translation.x, translation.y, dirVec.x, dirVec.y, 20, Drawings::ps_solid, ColorClasses::white);                \
    POLYGON(id, 4, bodyPoints, 20, Drawings::ps_solid, ColorClasses::black, Drawings::bs_solid, color);                     \
    CIRCLE(id, translation.x, translation.y, 42, 0, Drawings::ps_solid, ColorClasses::black, Drawings::bs_solid, color);    \
  })
...
/**
 * A macro that sends a simplified covariance ellipse
 * @param id A drawing id
 * @param cov The covariance matrix as Matrix2x2<>
 * @param mean The mean value
 */
#define SIMPLE_COVARIANCE2D(id, cov, mean, penWidth, penStyle, penColor)                                                    \
  COMPLEX_DRAWING(id, {                                                                                                     \
    const float factor = 1.f;                                                                                               \
    const float cov012 = cov[0][1] * cov[0][1];                                                                             \
    const float varianceDiff = cov[0][0] - cov[1][1];                                                                       \
    ...
    const float angle = 0.5f * std::atan2(2.0f * cov[0][1], varianceDiff);                                                  \
                                                                                                                            \
    ELLIPSE(id, mean, axis1, axis2, angle, penWidth, penStyle, penColor, Drawings::bs_null, ColorRGBA());                   \
  });
