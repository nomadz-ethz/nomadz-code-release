...
private:
  ...
  static PROCESS_WIDE_STORAGE(RoboCup::SPLStandardMessage) theStdMsg;
...
public:
  ...
  /**
   * The method returns a reference to the process wide instance.
   * @return The instance of the Standard Message in this process.
   */
  static RoboCup::SPLStandardMessage& getStdMsg() { return *theStdMsg; }
  ...
  friend class Rf;
  friend struct RoboCup::SPLStandardMessage;
};
