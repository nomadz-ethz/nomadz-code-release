 ...
 *
 * @note The original authors are <a href="mailto:Thomas.Roefer@dfki.de">Thomas Röfer</a> and Martin Lötzsch
 */
...
private:
  ...
  bool writingOfLastMessageFailed; /**< If true, then the writing of the last message failed because there was not enough
                                      space. */
