...
#else
#define ASSERT(cond)                                                                                                        \
  ((void)((cond) ? 0 : (Assert::print(__FILE__, __LINE__, "ASSERT(%s) failed", #cond), Assert::abort(), 0)))
#endif
...
#else
#define VERIFY(cond)                                                                                                        \
  ((void)((cond) ? 0 : (Assert::print(__FILE__, __LINE__, "VERIFY(%s) failed", #cond), Assert::abort(), 0)))
#endif
