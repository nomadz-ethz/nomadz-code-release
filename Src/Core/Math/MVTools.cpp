...
namespace MVTools {
  ...
  bool isNearZero(float value) {
    if ((value > minNegFloat) && (value < minPosFloat)) {
      return true;
    } else {
      return false;
    }
  ...
  bool isNearPosZero(float value) {
    if ((value >= 0.0) && (value < minPosFloat)) {
      return true;
    } else {
      return false;
    }
  ...
  bool isNearNegZero(float value) {
    if ((value > minNegFloat) && (value <= 0.0)) {
      return true;
    } else {
      return false;
    }
  ...
  bool isNearInf(float value) {
    if ((value > maxPosFloat) || (value < maxNegFloat)) {
      return true;
    } else {
      return false;
    }
  ...
  //------------------------------------------------------------------------------
  float getMaxPosFloat() { return maxPosFloat; }
  //------------------------------------------------------------------------------
  float getMinPosFloat() { return minPosFloat; }
  //------------------------------------------------------------------------------
  float getMaxExpFloat() { return maxExpFloat; }
  //------------------------------------------------------------------------------
  bool isNearZero(int value) {
    if ((value > minNegInt) && (value < minPosInt)) {
      return true;
    } else {
      return false;
    }
  ...
  bool isNearInf(int value) {
    if ((value > maxPosInt) || (value < maxNegInt)) {
      return true;
    } else {
      return false;
    }
  ...
  //------------------------------------------------------------------------------
  int getMaxPosInt() { return maxPosInt; }
  //------------------------------------------------------------------------------
  int getMinPosInt() { return minPosInt; }
  //------------------------------------------------------------------------------
  bool isNaN(float value) { return std::isnan(value) != 0; }
} // namespace MVTools
//------------------------------------------------------------------------------
