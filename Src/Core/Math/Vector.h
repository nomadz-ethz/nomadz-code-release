 ...
 *
 * @note The original author is <a href="mailto:martin.kallnik@gmx.de">Martin Kallnik</a>,
...
namespace vec {
  ...
  template <int n, class V> struct VectorData : public ImplicitlyStreamable { V v[n]; };
  ...
  public:
     ...
     */
    Vector<n, V> operator+(const Vector<n, V>& other) const { return Vector<n, V>(*this) += other; }
     ...
     * @return A new object that contains the result of the calculation.
     */
    Vector<n, V> operator*(const V& factor) const { return Vector<n, V>(*this) *= factor; }
     ...
     * @return A new object that contains the result of the calculation.
     */
    Vector<n, V> operator-() const { return Vector<n, V>() -= *this; }
     ...
     */
    inline V& operator[](int i) { return ((V*)this)[i]; }
     ...
     * @return reference to the coordinate
     */
    inline const V& operator[](int i) const { return ((const V*)this)[i]; }
...
typedef Vector<2, Angle> Vector2a;
typedef Vector<3, Angle> Vector3a;
