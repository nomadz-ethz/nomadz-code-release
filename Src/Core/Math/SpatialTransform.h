...
public:
  ...
  SpatialTransform operator*(const SpatialTransform& other) const { return SpatialTransform(*this) *= other; }
  ...
  SpatialInertia transform(const SpatialInertia& inertia) const {
    ...
    return SpatialInertia(rotT * inertia.momentOfInertia * rot -
                            (posCross * rotTcCross + comNewCross * posCross) * inertia.mass,
                          comNew,
                          inertia.mass);
  }
