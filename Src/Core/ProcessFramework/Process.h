...
#include "Core/Debugging/TimingManager.h"
...
private:
  ...
  RoboCup::SPLStandardMessage stdMsg;
...
#define INIT_DEBUGGING                                                                                                      \
  Process(theDebugReceiver, theDebugSender), theDebugReceiver(this, "Receiver.MessageQueue.O"),                             \
