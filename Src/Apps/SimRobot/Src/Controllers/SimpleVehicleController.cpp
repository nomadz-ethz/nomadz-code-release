...
private:
  ...
  enum VehicleState { SEARCH_FOR_BALL = 0, GO_TO_BALL } vehicleState; /** Different states for the robot behavior */
...
public:
  ...
  bool compile() {
    ...
    SimRobotCore2::Object* vehicleObj =
      (SimRobotCore2::Object*)simRobot.resolveObject("SimpleVehicle.car", SimRobotCore2::body);
