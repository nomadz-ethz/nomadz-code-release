...
SceneGraphDockWidget::SceneGraphDockWidget(QMenu* contextMenu, QWidget* parent)
    : QDockWidget(parent), contextMenu(contextMenu) {
...
void SceneGraphDockWidget::registerObject(const SimRobot::Module* module,
...
SimRobot::Object* SceneGraphDockWidget::resolveObject(const QString& fullName, int kind) {
  for (QHash<int, QHash<QString, RegisteredObject*>*>::iterator i = kind ? registeredObjectsByKindAndName.find(kind)
                                                                         : registeredObjectsByKindAndName.begin();
...
SimRobot::Object*
SceneGraphDockWidget::resolveObject(const SimRobot::Object* parent, const QVector<QString>& parts, int kind) {
...
void SceneGraphDockWidget::deleteRegisteredObjectsFromModule(RegisteredObject* registeredObject,
