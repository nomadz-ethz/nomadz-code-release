...
namespace SimRobot {
  ...
  public:
    ...
    static const int copy = 0x0008; /**< The object's widget has a "copy" entry in its edit menu that can be used to copy a
                                       screenshot of the widget to the clipboard */
    static const int exportAsImage = 0x0010; /**< The object's widget  has an "Export Image" entry in its edit menu that can
                                                be used to create a svg using the \c paint method of the widget */
  ...
  public:
    ...
    /**
     * Called after all modules have been compiled. In this phase the module can update references to scene graph objects of
     * other modules. (using \c resolveObject)
     */
    virtual void link() {}
