...
typedef HRESULT(WINAPI* PtrGetCurrentThemeName)(OUT LPWSTR pszThemeFileName,
                                                int cchMaxNameChars,
...
public:
  ...
  enum InternalPalette { Blue, Silver, Olive, System, Classic };
...
QLinearGradient QtDotNetStylePrivate::toolbarGradient(const QStyleOption* option,
                                                      QRect rect,
...
QLinearGradient QtDotNetStylePrivate::menuGradient(const QStyleOption* option,
                                                   QRect rect,
                                                   Qt::Orientation orientaion = Qt::Horizontal) const {
...
/*!
    ...
    theme (\c Office).
*/
QtDotNetStyle::QtDotNetStyle() : QWindowsVistaStyle(), d(new QtDotNetStylePrivate()) {
  d->theme = Office;
...
/*!
    ...
    colortheme.
*/
QtDotNetStyle::QtDotNetStyle(ColorTheme colortheme) : QWindowsVistaStyle(), d(new QtDotNetStylePrivate()) {
  d->theme = colortheme;
}
...
/*!
 \reimp
 */
void QtDotNetStyle::drawPrimitive(PrimitiveElement element,
  ...
  case PE_PanelLineEdit:
    if (widget && qobject_cast<QToolBar*>(widget->parentWidget())) {
      ...
      painter->save();
      bool active = option->state & State_Active && ((option->state & State_MouseOver) || (option->state & State_HasFocus));
  ...
  case PE_FrameMenu: {
    ...
    if (const QStyleOptionToolBar* toolbar = qstyleoption_cast<const QStyleOptionToolBar*>(option)) {
      Qt::Orientation orientation =
        (toolbar->toolBarArea == Qt::RightToolBarArea || toolbar->toolBarArea == Qt::LeftToolBarArea) ? Qt::Vertical
                                                                                                      : Qt::Horizontal;
    ...
    if (const QMainWindow* mw = qobject_cast<const QMainWindow*>(widget)) {
      ...
      if (QStatusBar* statusBar = mw->findChild<QStatusBar*>()) {
        if (statusBar->isVisible()) {
          ...
          painter->drawLine(windowRect.bottomLeft() + QPoint(0, 1), windowRect.bottomRight() + QPoint(0, 1));
        }
      }
...
/*!
 \reimp
 */
void QtDotNetStyle::drawControl(ControlElement element,
                                const QStyleOption* option,
                                QPainter* painter,
                                const QWidget* widget) const {
  ...
  case CE_MenuItem:
    ...
    if (const QStyleOptionMenuItem* menuitem = qstyleoption_cast<const QStyleOptionMenuItem*>(option)) {
      ...
      QRect vCheckRect = visualRect(
        option->direction, menuitem->rect, QRect(menuitem->rect.x(), menuitem->rect.y(), checkcol, menuitem->rect.height()));
      ...
      if (!s.isEmpty()) { // draw text
        ...
        if (t >= 0) {
          QRect vShortcutRect = visualRect(option->direction,
                                           menuitem->rect,
      ...
      */
      ...
      if (!dockWidget->title.isEmpty()) {
        ...
        drawItemText(painter,
                     ...
                     palette,
                     dockWidget->state & State_Enabled,
                     titleText,
                     QPalette::WindowText);
      }
      painter->restore();
...
/*!
 \reimp
 */
void QtDotNetStyle::drawComplexControl(ComplexControl control,
    ...
    if (widget && qobject_cast<QToolBar*>(widget->parentWidget())) {
      ...
      if (const QStyleOptionComboBox* cmb = qstyleoption_cast<const QStyleOptionComboBox*>(option)) {
        bool active = cmb->state & State_Active &&
                      ((cmb->state & State_MouseOver) || (cmb->state & State_On) || (cmb->state & State_HasFocus));
  ...
  case CC_ToolButton:
    if (const QStyleOptionToolButton* toolbutton = qstyleoption_cast<const QStyleOptionToolButton*>(option)) {
      ...
      if ((widget && qobject_cast<QToolBar*>(widget->parentWidget())) &&
          ((toolbutton->state & State_MouseOver && toolbutton->state & State_Enabled) || toolbutton->state & State_On)) {
...
/*!
 \reimp
 */
QSize QtDotNetStyle::sizeFromContents(ContentsType type,
                                      const QStyleOption* option,
                                      const QSize& size,
                                      const QWidget* widget) const {
  QSize newSize;
...
/*!
 \reimp
 */
QRect QtDotNetStyle::subControlRect(ComplexControl control,
                                    const QStyleOptionComplex* option,
...
/*!
 \reimp
 */
QStyle::SubControl QtDotNetStyle::hitTestComplexControl(ComplexControl control,
                                                        const QStyleOptionComplex* option,
                                                        const QPoint& pos,
                                                        const QWidget* widget) const {
  if (QSysInfo::WindowsVersion >= QSysInfo::WV_VISTA && QSysInfo::WindowsVersion < QSysInfo::WV_NT_based)
...
void QtDotNetStylePrivate::updatePalette() {
  ...
  if (pIsAppThemed && pIsAppThemed() &&
      pGetCurrentThemeName(themeFileName, maxlength, themeColor, maxlength, NULL, 0) == S_OK) {
...
/*!
 \reimp
 */
QPixmap QtDotNetStyle::standardPixmap(StandardPixmap standardPixmap, const QStyleOption* opt, const QWidget* widget) const {
  if (QSysInfo::WindowsVersion >= QSysInfo::WV_VISTA && QSysInfo::WindowsVersion < QSysInfo::WV_NT_based)
...
/*!
  \reimp
*/
int QtDotNetStyle::styleHint(StyleHint hint,
                             const QStyleOption* option,
