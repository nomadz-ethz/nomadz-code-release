/**
 * @file SimRobot/SimRobotWindow.h
...
private:
  ...
  public:
    ...
    RegisteredModule(const QString& name, const QString& displayName, int flags)
        : name(name), displayName(displayName), flags(flags) {}
  };
  ...
  virtual bool
  registerObject(const SimRobot::Module& module, SimRobot::Object& object, const SimRobot::Object* parent, int flags);
