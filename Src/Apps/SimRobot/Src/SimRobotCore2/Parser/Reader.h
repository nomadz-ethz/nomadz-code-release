...
protected:
   ...
   * @param callHandler Whether the handler function (\c handleNode) should be called for each subordinate node. Set it to \c
   * false to pass the children of unexepcted elements.
