...
void VelocityMotor::PositionSensor::updateValue() {
  data.floatValue = dJointGetType(joint->joint) == dJointTypeHinge ? (float)dJointGetHingeAngle(joint->joint)
...
void VelocityMotor::VelocitySensor::updateValue() {
  data.floatValue = dJointGetType(joint->joint) == dJointTypeHinge ? (float)dJointGetHingeParam(joint->joint, dParamVel)
