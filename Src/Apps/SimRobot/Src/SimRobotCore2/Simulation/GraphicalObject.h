...
public:
  ...
  /** Draws appearance primitives of the object (including children) on the currently selected OpenGL context (in order to
   * create a display list) */
  virtual void assembleAppearances() const;

  /** Draws appearance primitives of the object (including children) on the currently selected OpenGL context (as fast as
   * possible) */
