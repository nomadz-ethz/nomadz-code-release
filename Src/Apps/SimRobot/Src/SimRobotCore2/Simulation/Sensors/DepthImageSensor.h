...
public:
  ...
  enum Projection { perspectiveProjection, sphericalProjection } projection;
...
private:
  ...
  public:
    ...
    unsigned int renderWidth;  /** The horizontal number of pixels to render. Only differs from depthImageSensor->imageWidth
