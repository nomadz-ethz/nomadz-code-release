...
CoreModule::CoreModule(SimRobot::Application& application)
    : sceneIcon(":/Icons/bricks.png"), objectIcon(":/Icons/brick.png"), sensorIcon(":/Icons/transmit_go.png"),
      actuatorIcon(":/Icons/arrow_rotate_clockwise.png"), hingeIcon(":/Icons/link.png"), sliderIcon(":/Icons/slider.png"),
      appearanceIcon(":/Icons/note.png") {
  ...
  private:
    ...
    virtual void update() {
      ...
      if (renderingMethod != lastRenderingMethod) {
        ...
        static const char* renderingMethods[] = {"unkn renderer", "pbuf renderer", "fbuf renderer", "hwin renderer"};
        setText(renderingMethods[(renderingMethod < 0 ||
                                  renderingMethod >= int(sizeof(renderingMethods) / sizeof(*renderingMethods)))
                                   ? 0
                                   : renderingMethod]);
      }
    }
