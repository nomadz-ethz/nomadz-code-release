...
public:
  bad_cm_cast(const std::string& reason) : msg(reason) {}
...
#define CONFIGMAP_STREAM_IN(cvType, vType)                                                                                  \
  ...
  template <> ConfigValue* createConfigValueFor<vType>(const vType& value) { return new cvType(); }
...
protected:
  ConfigValueBase() : comment(""), parent(0) {}
...
protected:
  virtual ConfigValue* deepCopy() const { return new PlainConfigValue(*this); }
...
public:
  ...
  virtual operator PlainConfigValue&() { return *this; }
  virtual operator const PlainConfigValue&() const { return *this; }
...
protected:
  virtual ConfigValue* deepCopy() const { return new ListConfigValue(*this); }
...
public:
  ...
  virtual operator ListConfigValue&() { return *this; }

  virtual operator const ListConfigValue&() const { return *this; }
...
protected:
  virtual ConfigValue* deepCopy() const { return new ConfigMap(*this); }
...
public:
  ...
  virtual operator ConfigMap&() { return *this; }

  virtual operator const ConfigMap&() const { return *this; }
