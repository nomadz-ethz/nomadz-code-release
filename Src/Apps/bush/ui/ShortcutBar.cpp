...
QAction* ShortcutBar::addShortcut(const QString& name, const QString& command, QIcon* icon) {
  QIcon _icon;
  if (icon)
    _icon = *icon;
  else
...
QAction* ShortcutBar::addShortcut(const QString& name, const QString& command, const QString& icon) {
