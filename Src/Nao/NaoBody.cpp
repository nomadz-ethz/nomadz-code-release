...
bool NaoBody::getWlanStatus() {
  return access("/sys/class/net/wlan0", F_OK) == 0 || access("/sys/class/net/wlp1s0", F_OK);
}
...
void NaoBody::setRobotInfo(uint8_t teamNumber,
                           ...
                           float ballX,
                           float ballY,
                           int refereeChallengeSignal,
                           float refereeChallengeTimeSinceWhistle) {
  ASSERT(naoBodyAccess.lbhData != (LBHData*)MAP_FAILED);
  naoBodyAccess.lbhData->robotInfo[::teamNumber] = teamNumber;
  naoBodyAccess.lbhData->robotInfo[::fieldPlayerColour] = fieldPlayerColour;
  ...
  naoBodyAccess.lbhData->robotInfo[::refereeChallengeSignal] = refereeChallengeSignal;
  naoBodyAccess.lbhData->robotInfo[::refereeChallengeTimeSinceWhistle] = refereeChallengeTimeSinceWhistle;
