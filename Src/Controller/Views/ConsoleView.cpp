...
ConsoleWidget::ConsoleWidget(ConsoleView& consoleView,
                             ConsoleRoboCupCtrl& console,
                             QString& output,
                             ConsoleWidget*& consoleWidget)
    : consoleView(consoleView), console(console), output(output), consoleWidget(consoleWidget), canCopy(false),
...
void ConsoleWidget::keyPressEvent(QKeyEvent* event) {
  ...
  case Qt::Key_Right: { // avoid jumping to the next line when the right arrow key is used to accept suggestions from tab
                        // completion
    bool handled = false;
