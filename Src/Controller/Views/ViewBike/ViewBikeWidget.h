...
public:
  ViewBikeWidget(ViewBike& viewBike, KickEngineParameters& parameters, ViewBikeHeaderedWidget* parent);
...
private:
  ...
  int getString, ghost; // set the opacitiy of the robot model
