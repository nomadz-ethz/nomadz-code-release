...
ViewBikeGLWidget::ViewBikeGLWidget(ViewBike& viewBike, KickEngineParameters& parameters, ViewBikeWidget* parent)
    : QGLWidget(parent), widget(*parent), viewBike(viewBike), renderer(*viewBike.robot->createRenderer()),
      parameters(parameters), moveDrag(false), moveViewOfViewDragXY(false), moveViewOfViewDragXZ(false),
      moveViewOfViewDragYZ(false), moveViewOfViewDragXP(false), moveViewOfViewDragYP(false), moveViewOfViewDragZP(false) {
  GLubyte test[17][128] = {
    ...
    {},

    {},

    {},

    {},

    {},

    {},

    {},

    {},

    {},

    {},

    {},

    {},

    {},

    {},

    {},
...
void ViewBikeGLWidget::initializeGL() {
  ...
  renderer.setRenderFlags((renderer.getRenderFlags() & ~SimRobotCore2::Renderer::showCoordinateSystem) |
                          SimRobotCore2::Renderer::showAsGlobalView);
  renderer.resetCamera();
  Vector3<> cameraPos(0, -1.f, 0.f), targetPos;
...
bool ViewBikeGLWidget::clickControlPoint(const int& x, const int& y) {
  ...
  for (int phaseNumber = 0; phaseNumber < parameters.numberOfPhases; phaseNumber++) {
      ...
      if (!widget.singleDraw || phaseNumber == widget.selectedPoint.phaseNumber) {
        for (int limb = 0; limb < Phase::numOfLimbs; limb++) {
          for (unsigned int i = 0; i < NUM_OF_POINTS; i++) {
            ...
            if (ViewBikeMath::intersectRayAndBox(vecNear, vecFar, cubePoint, originRot, 15.0, 15.0, 15.0, intersection) &&
                limb != Phase::leftFootRot && limb != Phase::rightFootRot && limb != Phase::rightHandRot &&
    ...
    if ((widget.tra2dWindows || widget.tra1dWindows) && !moveViewOfViewDragXY && !moveViewOfViewDragXZ &&
        !moveViewOfViewDragYZ && !moveViewOfViewDragXP && !moveViewOfViewDragYP && !moveViewOfViewDragZP) {
      if (widget.selectedPoint.phaseNumber > -1 && widget.selectedPoint.limb > -1) {
        ...
        for (unsigned int k = 0; k < NUM_OF_POINTS; k++) {
          Vector3<> controlPoint =
            parameters.phaseParameters[widget.selectedPoint.phaseNumber].controlPoints[widget.selectedPoint.limb][k];
        ...
        float scaleFactorX = mini_window_width / std::max<>(maxXrange - minXrange, 1.0f),
...
void ViewBikeGLWidget::drawBezierCurves(const int& phaseNumber) {
  ...
  for (int j = 0; j < Phase::numOfLimbs; j++) {
    for (unsigned int i = 0; i < NUM_OF_POINTS; i++) {
      ...
      if ((unsigned int)widget.selectedPoint.pointNumber == i) {
        if (moveDrag || moveViewOfViewDragYP || moveViewOfViewDragZP || moveViewOfViewDragXP || moveViewOfViewDragXY ||
            moveViewOfViewDragXZ || moveViewOfViewDragYZ) {
      ...
      if (j == Phase::leftFootRot) {
        ...
        drawPos =
          RotationMatrix::fromRotationZ(cubePoint[i][j].z) * RotationMatrix::fromRotationX(cubePoint[i][j].x) * drawPos;
        ...
        drawPos2 =
          RotationMatrix::fromRotationZ(cubePoint[i][j].z) * RotationMatrix::fromRotationY(cubePoint[i][j].y) * drawPos2;
      ...
      if (j == Phase::leftHandRot) {
        ...
        lHDrawPos = RotationMatrix::fromRotationZ(cubePoint[i][j].z) * RotationMatrix::fromRotationY(cubePoint[i][j].y) *
      ...
      if (j == Phase::rightHandRot) {
        ...
        rHDrawPos = RotationMatrix::fromRotationZ(cubePoint[i][j].z) * RotationMatrix::fromRotationY(cubePoint[i][j].y) *
      ...
      if (i == NUM_OF_POINTS - 1) {
        ...
        if ((unsigned int)widget.selectedPoint.pointNumber == i && widget.selectedPoint.limb == j &&
            widget.selectedPoint.phaseNumber == phaseNumber) {
          if (moveDrag || moveViewOfViewDragYP || moveViewOfViewDragZP || moveViewOfViewDragXP || moveViewOfViewDragXY ||
              moveViewOfViewDragXZ || moveViewOfViewDragYZ) {
            glColor4f(1.0f, 0.0f, 1.0f, 1.0f); // magenta moved selected point
  ...
  for (float phase = 0.0f; phase < 1.0f; phase += 0.02f) {
    ...
    bool leftLegTooShort = ViewBikeMath::calcLegJoints(positions[Phase::leftFootTra],
                                                       positions[Phase::leftFootRot],
                                                       true,
                                                       viewBike.robotDimensions,
                                                       leg0,
                                                       leg1,
                                                       leg2,
                                                       leg3,
    ...
    if (clipLegJointsWithLimits(leg1, leg2, leg3, JointData::LHipYawPitch) || leftLegTooShort) {
      positions[Phase::leftFootTra] =
        ViewBikeMath::calcFootPos(leg0, leg1, leg2, leg3, leg4, leg5, JointData::LHipYawPitch, viewBike.robotDimensions);
    ...
    bool rightLegTooShort = ViewBikeMath::calcLegJoints(positions[Phase::rightFootTra],
                                                        positions[Phase::rightFootRot],
                                                        false,
                                                        viewBike.robotDimensions,
                                                        leg0,
                                                        leg1,
    ...
    if (clipLegJointsWithLimits(leg1, leg2, leg3, JointData::RHipYawPitch) || rightLegTooShort) {
      positions[Phase::rightFootTra] =
        ViewBikeMath::calcFootPos(leg0, leg1, leg2, leg3, leg4, leg5, JointData::RHipYawPitch, viewBike.robotDimensions);
      glColor4f(1.0f, 0.5f, 0.f, 1.f);
...
void ViewBikeGLWidget::calculateControlPointRot(const Vector3<>& point0,
                                                const Vector3<>& point1,
                                                const Vector3<> point2,
                                                Vector3<>& rotation) {
  Vector3<> vec1(point2.x - point1.x, point2.y - point1.y, point2.z - point1.z);
  ...
  if (vec1.abs() > 1.f) {
    ...
    Vector3<> vec(point2.x - point0.x, point2.y - point0.y, point2.z - point0.z);
...
void ViewBikeGLWidget::paintGL() {
  ...
  if (viewBike.motionRequest.motion == MotionRequest::kick && widget.lastMotion != MotionRequest::kick) {
  ...
  if (viewBike.motionRequest.motion == MotionRequest::kick && widget.reachedDraw) {
    Vector3<> positions[Phase::numOfLimbs];

    positions[Phase::leftFootTra] =
      ViewBikeMath::calculateFootPos(
        viewBike.sensorData, viewBike.jointData, JointData::LHipYawPitch, viewBike.robotDimensions)
        .translation;
    positions[Phase::rightFootTra] =
      ViewBikeMath::calculateFootPos(
        viewBike.sensorData, viewBike.jointData, JointData::RHipYawPitch, viewBike.robotDimensions)
        .translation;

    positions[Phase::leftArmTra] =
      ViewBikeMath::calculateHandPos(viewBike.jointData, JointData::LShoulderPitch, viewBike.robotDimensions).translation;
    positions[Phase::rightArmTra] =
      ViewBikeMath::calculateHandPos(viewBike.jointData, JointData::RShoulderPitch, viewBike.robotDimensions).translation;
  ...
  if (widget.tra2dWindows || widget.tra1dWindows || widget.velocityWindows || widget.accelWindows) {
    ...
    if (widget.tra2dWindows) {
      ...
      renderText(
        0.5f, -mini_window_height * 2 - offsetBetween * 2 + 4.0f, 0, "[z:phase]  with phase = [0..1]", QFont("arial", 10));
    ...
    if (widget.selectedPoint.phaseNumber > -1 && widget.selectedPoint.limb > -1) {
      ...
      if (widget.tra1dWindows || widget.tra2dWindows) {
        ...
        for (float phase = 0.f; phase <= 1.f; phase += 0.01f) {
          ...
          if (widget.velocityWindows) {
            point.x = (-3.f + 6.f * phase - 3.f * phase * phase) * p0.x +
                      3.f * (2 * phase - 4.f * phase + 3.f * phase * phase) * cpWindow1[0].y +
                      3.f * (2.f * phase - 3.f * phase * phase) * cpWindow1[1].y + 3.f * phase * phase * cpWindow1[2].y;
            point.y = (-3.f + 6.f * phase - 3.f * phase * phase) * p0.y +
                      3.f * (2 * phase - 4.f * phase + 3.f * phase * phase) * cpWindow2[0].y +
                      3.f * (2.f * phase - 3.f * phase * phase) * cpWindow2[1].y + 3.f * phase * phase * cpWindow2[2].y;
            point.z = (-3.f + 6.f * phase - 3.f * phase * phase) * p0.z +
                      3.f * (2 * phase - 4.f * phase + 3.f * phase * phase) * cpWindow3[0].y +
                      3.f * (2.f * phase - 3.f * phase * phase) * cpWindow3[1].y + 3.f * phase * phase * cpWindow3[2].y;
          } else {
            point.x = (6.f - 6.f * phase) * p0.x + 3.f * (-2.f + 6.f * phase) * cpWindow1[0].y +
                      3.f * (2.f - 6.f * phase) * cpWindow1[1].y + 6.f * phase * cpWindow1[2].y;
            point.y = (6.f - 6.f * phase) * p0.y + 3.f * (-2.f + 6.f * phase) * cpWindow2[0].y +
                      3.f * (2.f - 6.f * phase) * cpWindow2[1].y + 6.f * phase * cpWindow2[2].y;
            point.z = (6.f - 6.f * phase) * p0.z + 3.f * (-2.f + 6.f * phase) * cpWindow3[0].y +
                      3.f * (2.f - 6.f * phase) * cpWindow3[1].y + 6.f * phase * cpWindow3[2].y;
          }
      ...
      if (widget.tra2dWindows) {
        ...
        draw2dCurves(minXrange,
                     ...
                     colorX,
                     colorZ,
                     -mini_window_height * 2 - offsetBetween,
                     cpWindow2,
                     pWindow2);
        draw2dCurves(minYrange,
                     minZrange,
                     maxYrange,
                     maxZrange,
                     scaleFactorY1,
                     ...
                     colorY,
                     colorZ,
                     -mini_window_height * 3 - offsetBetween * 2,
                     cpWindow3,
                     pWindow3);
      } else {
  ...
  if (moveDrag || moveViewOfViewDragXY || moveViewOfViewDragXZ || moveViewOfViewDragYZ || moveViewOfViewDragXP ||
    ...
    showPlane();
    Vector3<> point = parameters.phaseParameters[widget.selectedPoint.phaseNumber]
                        .controlPoints[widget.selectedPoint.limb][widget.selectedPoint.pointNumber];
    glDisable(GL_DEPTH_TEST);
...
void ViewBikeGLWidget::draw2dCurves(const float& minA,
                                    const float& minB,
                                    const float& maxA,
                                    const float& maxB,
                                    ...
                                    float* colorB,
                                    const float& window,
                                    const std::vector<Vector2<>>& cp,
                                    const std::vector<Vector2<>>& point) {
  glPushMatrix();
  ...
  for (float w = std::ceil(minA / tickA) * tickA; w <= maxA + 0.01; w += tickA) {
    if (std::abs(w) > 0.001) // don't draw zeroline twice
    {
      ...
      glEnd();
      renderText(
        double(w + transA), double(minB + transB - 15.0f / scaleFactorB), 0.0, QString::number(w), QFont("arial", 8));
    }
  }
  ...
  for (float h = std::ceil(minB / tickB) * tickB; h <= maxB + 0.01; h += tickB) {
    if (std::abs(h) > 0.001) // don't draw zeroline twice
    {
      ...
      glEnd();
      renderText(
        (double)(minA + transA - 30.0f / scaleFactorA), (double)(h + transB), 0.0, QString::number(h), QFont("arial", 8));
    }
  }
...
void ViewBikeGLWidget::mouseMoveEvent(QMouseEvent* event) {
  ...
  if ((moveDrag || moveViewOfViewDragXY || moveViewOfViewDragXZ || moveViewOfViewDragYZ || moveViewOfViewDragXP ||
    ...
    Vector3<> p;
    if (!moveViewOfViewDragXY && !moveViewOfViewDragXZ && !moveViewOfViewDragYZ && !moveViewOfViewDragXP &&
        !moveViewOfViewDragYP && !moveViewOfViewDragZP) {
      p = parameters.phaseParameters[widget.selectedPoint.phaseNumber]
            .controlPoints[widget.selectedPoint.limb][widget.selectedPoint.pointNumber];
      ...
      if (widget.selectedPoint.limb == Phase::leftFootRot)
      {
        if (widget.selectedPoint.xzRot)
        {
          ...
          drawPos.rotateX(p.x);
          drawPos.rotateZ(p.z);
          p = Vector3<>(parameters.footOrigin.x + drawPos.x,parameters.footOrigin.y + drawPos.y, parameters.footOrigin.z +
      drawPos.z);
        }
        else
        {
          ...
          p = Vector3<>(parameters.footOrigin.x + drawPos2.x, parameters.footOrigin.y + drawPos2.y, parameters.footOrigin.z +
      drawPos2.z);
        }
      }
      ...
      Vector3<> position(p);
      if (ViewBikeMath::intersectRayAndPlane(vecNear, vecFar, position, widget.dragPlane, planeIntersection)) {
      ...
      if (moveViewOfViewDragXY) {
        windowVec = Vector3<>(((event->x() - (width - 20.f - width / 3.0f)) / scaleFactorX) + minXrange,
                              ((event->y() - mini_window_height - 20.0f) / -scaleFactorY) + minYrange,
                              0.0);
        p.z = 0.f;
      }
      if (moveViewOfViewDragXZ) {
        windowVec = Vector3<>(((event->x() - (width - 20.f - width / 3.0f)) / scaleFactorX) + minXrange,
                              0.0,
                              ((event->y() - mini_window_height * 2 - 55.0f) / -scaleFactorZ) + minZrange);
        p.y = 0.f;
      }
      if (moveViewOfViewDragYZ) {
        windowVec = Vector3<>(0.0,
                              ((event->x() - (width - 20.f - width / 3.0f)) / scaleFactorY1) + minYrange,
    ...
    parameters.phaseParameters[widget.selectedPoint.phaseNumber]
      .controlPoints[widget.selectedPoint.limb][widget.selectedPoint.pointNumber]
      .x += (float)translationVec.x;
    parameters.phaseParameters[widget.selectedPoint.phaseNumber]
      .controlPoints[widget.selectedPoint.limb][widget.selectedPoint.pointNumber]
      .y += (float)translationVec.y;
    parameters.phaseParameters[widget.selectedPoint.phaseNumber]
      .controlPoints[widget.selectedPoint.limb][widget.selectedPoint.pointNumber]
      .z += (float)translationVec.z;

    if (widget.selectedPoint.limb == Phase::leftFootRot || widget.selectedPoint.limb == Phase::rightFootRot) {
      if (parameters.phaseParameters[widget.selectedPoint.phaseNumber]
            .controlPoints[widget.selectedPoint.limb][widget.selectedPoint.pointNumber]
            .x > pi_4) {
        parameters.phaseParameters[widget.selectedPoint.phaseNumber]
          .controlPoints[widget.selectedPoint.limb][widget.selectedPoint.pointNumber]
    ...
    case 2:
      // p2
      parameters.phaseParameters[widget.selectedPoint.phaseNumber].controlPoints[widget.selectedPoint.limb][1].x +=
        (float)translationVec.x;
      parameters.phaseParameters[widget.selectedPoint.phaseNumber].controlPoints[widget.selectedPoint.limb][1].y +=
        (float)translationVec.y;
      parameters.phaseParameters[widget.selectedPoint.phaseNumber].controlPoints[widget.selectedPoint.limb][1].z +=
        (float)translationVec.z;
      // q1
      if (widget.selectedPoint.phaseNumber < parameters.numberOfPhases - 1) {
        parameters.phaseParameters[widget.selectedPoint.phaseNumber + 1].controlPoints[widget.selectedPoint.limb][0].x +=
          (float)translationVec.x;
        parameters.phaseParameters[widget.selectedPoint.phaseNumber + 1].controlPoints[widget.selectedPoint.limb][0].y +=
          (float)translationVec.y;
        parameters.phaseParameters[widget.selectedPoint.phaseNumber + 1].controlPoints[widget.selectedPoint.limb][0].z +=
          (float)translationVec.z;
      }
      break;
    }
  ...
  /* if (widget.selectedPoint.limb == Phase::leftFootRot)
   {
     if (widget.selectedPoint.xzRot)
     {
       ...
       point = Vector3<>(parameters.footOrigin.x + drawPos.x,parameters.footOrigin.y + drawPos.y, parameters.footOrigin.z +
   drawPos.z);
     }
     else
     {
       ...
       point = Vector3<>(parameters.footOrigin.x + drawPos2.x, parameters.footOrigin.y + drawPos2.y, parameters.footOrigin.z
   + drawPos2.z);
     }
   }
...
void ViewBikeGLWidget::setSteadyDiff() {
  ...
  for (int phaseNumber = 0; phaseNumber < parameters.numberOfPhases - 1; phaseNumber++) {
    float factor =
      (float)parameters.phaseParameters[phaseNumber + 1].duration / (float)parameters.phaseParameters[phaseNumber].duration;
    ...
    for (int j = 0; j < Phase::numOfLimbs; j++) {
      ...
      if (checkConstant.x == parameters.phaseParameters[phaseNumber + 1].controlPoints[j][2].x &&
        ...
        parameters.phaseParameters[phaseNumber + 1].controlPoints[j][1] =
          parameters.phaseParameters[phaseNumber + 1].controlPoints[j][0];
        parameters.phaseParameters[phaseNumber + 1].controlPoints[j][2] =
          parameters.phaseParameters[phaseNumber + 1].controlPoints[j][0];
      }
    }
  }
...
void ViewBikeGLWidget::clipCurve(Vector3<>& translationVec) {
  ...
  for (float t = 0.f; t < 1.01f; t += 0.01f) {
    ...
    if (widget.selectedPoint.limb == Phase::leftFootTra) {
      ...
      bool leftLegTooShort = ViewBikeMath::calcLegJoints(
        positions[0], positions[1], true, viewBike.robotDimensions, leg0, leg1, leg2, leg3, leg4, leg5);
    ...
    if (widget.selectedPoint.limb == Phase::rightFootTra) {
      ...
      bool rightLegTooShort = ViewBikeMath::calcLegJoints(
        positions[0], positions[1], false, viewBike.robotDimensions, leg0, leg1, leg2, leg3, leg4, leg5);
      if (clipLegJointsWithLimits(leg1, leg2, leg3, JointData::RHipYawPitch) || rightLegTooShort) {
        parameters.phaseParameters[widget.selectedPoint.phaseNumber]
          .controlPoints[widget.selectedPoint.limb][widget.selectedPoint.pointNumber]
          .x -= (float)translationVec.x;
...
void ViewBikeGLWidget::mousePressEvent(QMouseEvent* event) {
  ...
  if (event->button() == Qt::LeftButton) {
    ...
    if (renderer.startDrag(event->x(),
                           event->y(),
                           QApplication::keyboardModifiers() & Qt::ShiftModifier ? SimRobotCore2::Renderer::dragRotate
                                                                                 : SimRobotCore2::Renderer::dragNormal)) {
      event->accept();
      updateGL();
    }
  }
