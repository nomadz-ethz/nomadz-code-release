...
public:
  ViewBikeGLWidget(ViewBike& viewBike, KickEngineParameters& parameters, ViewBikeWidget* parent);
...
private:
  ...
  Vector3<> targetPosOffset, cameraPosOffset;
  ...
  void
  calculateControlPointRot(const Vector3<>& point0, const Vector3<>& point1, const Vector3<> point2, Vector3<>& rotation);
