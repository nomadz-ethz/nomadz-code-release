...
private:
  ENUM(TeamColor, firstTeamColor, red = firstTeamColor, blue);
  ...
  public:
    ...
    RingBuffer<unsigned int, 600> lineAnalyses;
    ...
    BallAfterKickPose ballAfterKickPose; // Imported from BH2012
    PassTarget passTarget;               // Imported from BH2012
