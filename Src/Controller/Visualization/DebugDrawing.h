 ...
 *
 * The DebugDrawing object provides member functions for painting simple graphic structures like lines, ellipses, polygons
 * and text. To use a DebugDrawing object, construct it, and then call its member functions.
 */
class DebugDrawing {
public:
  /** Default constructor. */
   ...
   */
  void arrow(Vector2<> start, Vector2<> end, Drawings::PenStyle penStyle, int width, ColorRGBA color);
   ...
   */
  void polygon(const Vector2<int>* points,
               int nCount,
               int width,
               Drawings::PenStyle penStyle,
               ColorRGBA penColor,
