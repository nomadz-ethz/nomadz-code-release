/**
 * @file DebugDrawing3D.h
 *
 * This file is subject to the terms of the BHuman 2013 License.
 * A copy of this license is included in LICENSE.B-Human.txt.
 * (c) 2022 BHuman and NomadZ team
 *
 * @note The original author is Philippe Schober
 */
...
public:
   ...
   */
  void quad(const Vector3<>* points, float width, ColorRGBA color);

  /**
   * Adds a polygon to the debug drawing.
   * @param points Points to an array of points that specifies the vertices of the polygon. Each point in the array is a
   * Point.
   * @param width Specifies the width of the border.
   * @param color Specifies the color of the polygon.
   */
  void polygon(const Vector3<>* points, float width, ColorRGBA color);
   ...
   */
  void dot(Vector3<> v, float w, ColorRGBA color);
   ...
   */
  void sphere(Vector3<> v, float radius, ColorRGBA color);
   ...
   */
  void image(Vector3<> v, Vector3<> rot, float w, float h, Image* i);
