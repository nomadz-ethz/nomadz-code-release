...
void OpenGLMethods::paintCubeToOpenGLList(int xLow,
                                          int yLow,
                                          int zLow,
                                          int xHigh,
                                          int yHigh,
...
inline void
OpenGLMethods::getColorClassColor(ColorClasses::Color colorClass, unsigned char& r, unsigned char& g, unsigned char& b) {
  switch (colorClass) {
...
void OpenGLMethods::paintImagePixelsToOpenGLList(
  const Image& image, int colorModel, int zComponent, bool polygons, int listID, int x1, int x2, int y1, int y2) {
  // Build a new list
  ::glNewList(listID, GL_COMPILE_AND_EXECUTE);
...
void OpenGLMethods::paintColorReference(const ColorReference& colorReference, ColorClasses::Color color, int listID) {
  // Build a new list
  ::glNewList(listID, GL_COMPILE_AND_EXECUTE);
