...
INSTANTIATE_ROS_HELPERS(ArmMovement)
...
INSTANTIATE_ROS_HELPERS(BodyTilt)
...
INSTANTIATE_ROS_HELPERS(ControllerParams)
INSTANTIATE_ROS_HELPERS(CoordinatedPassRepresentation)
...
INSTANTIATE_ROS_HELPERS(FootSteps)
INSTANTIATE_ROS_HELPERS(FootSupport)
INSTANTIATE_ROS_HELPERS(Footpositions)
...
INSTANTIATE_ROS_HELPERS(ObservedError)
INSTANTIATE_ROS_HELPERS(ObservedFLIPMError)
...
INSTANTIATE_ROS_HELPERS(PassHelper)
INSTANTIATE_ROS_HELPERS(PassTarget)
INSTANTIATE_ROS_HELPERS(PatternGenRequest)
...
INSTANTIATE_ROS_HELPERS(RefZMP)
INSTANTIATE_ROS_HELPERS(ReferenceModificator)
...
INSTANTIATE_ROS_HELPERS(WalkCalibration)
...
INSTANTIATE_ROS_HELPERS(WalkingEngineParams)
INSTANTIATE_ROS_HELPERS(WalkingInfo)
INSTANTIATE_ROS_HELPERS(Whistle)
INSTANTIATE_ROS_HELPERS(ZMPModel)
...
INSTANTIATE_ROS_HELPERS(KinematicOutput)
INSTANTIATE_ROS_HELPERS(WalkingEngineStandOutput)
INSTANTIATE_ROS_HELPERS(Thumbnail)
INSTANTIATE_ROS_HELPERS(ActualCoM)
INSTANTIATE_ROS_HELPERS(ActualCoMRCS)
INSTANTIATE_ROS_HELPERS(ActualCoMFLIPM)
