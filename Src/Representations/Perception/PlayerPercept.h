...
public:
  STREAMABLE_ROS(
    PerceptPlayer,
    {
      ...
      FIELD_WRAPPER(float, 0.f, nomadz_msgs::msg::PerceptPlayer::probability, probability),
      FIELD_WRAPPER(float, -0.5f, nomadz_msgs::msg::PerceptPlayer::jersey_ratio, jerseyRatio),
      FIELD_WRAPPER(int, 0, nomadz_msgs::msg::PerceptPlayer::jersey_y0, jerseyY0), // bottom of possible jersey in image
      FIELD_WRAPPER(int, 0, nomadz_msgs::msg::PerceptPlayer::jersey_y1, jerseyY1), // top of possible jersey in image
      FIELD_WRAPPER(bool, false, nomadz_msgs::msg::PerceptPlayer::is_goal_keeper, isGoalKeeper),
