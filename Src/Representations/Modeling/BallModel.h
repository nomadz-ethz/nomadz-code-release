...
public:
  ...
  operator BallModel() const,
    ...
    (Vector2<short>)position, (Vector2<short>)velocity, (Matrix2x2<>)positionCovariance,
    ...
    (unsigned)(INT_MAX)timeSinceLastSeen, /**< The time in milliseconds since time the ball was last seen */
