...
STREAMABLE_ROS(
  WalkingEngineOutput,
  {
    ...
    FIELD_WRAPPER_DEFAULT(Pose3D, nomadz_msgs::msg::WalkingEngineOutput::requested_right_foot, requestedRightFoot),
    FIELD_WRAPPER_DEFAULT(Pose3D, nomadz_msgs::msg::WalkingEngineOutput::requested_left_foot, requestedLeftFoot),
  });
