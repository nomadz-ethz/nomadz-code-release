...
#ifdef ENABLE_ROS
#include "nomadz_msgs/msg/in_walk_kick_request.hpp"
#include "nomadz_msgs/msg/walk_request.hpp"
#endif

STREAMABLE_DECLARE(WalkRequest)
STREAMABLE_DECLARE(InWalkKickRequest)

STREAMABLE_ROS(InWalkKickRequest, {
public:
  ENUM(KickType, none, straightKick, accKick, blindKick, omniKick, circleAround, alignment);
  , FIELD_WRAPPER(KickType, none, nomadz_msgs::msg::InWalkKickRequest::kick_type, kickType),
    FIELD_WRAPPER_DEFAULT(Vector2<>, nomadz_msgs::msg::InWalkKickRequest::ball_position, ballPosition),
    FIELD_WRAPPER(
      float, 0.6f, nomadz_msgs::msg::InWalkKickRequest::kick_strength, kickStrength), /**< Kick strength for kick. */
    FIELD_WRAPPER(
      float, 0.f, nomadz_msgs::msg::InWalkKickRequest::kick_direction, kickDirection), /**< Kick direction for kick. */
});
...
public:
  ...
  ,
    ...
    FIELD_WRAPPER_DEFAULT(InWalkKickRequest, nomadz_msgs::msg::WalkRequest::in_walk_kick_request, inWalkKickRequest),
    // Generic
